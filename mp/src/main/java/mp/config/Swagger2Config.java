...
public class Swagger2Config implements WebMvcConfigurer {
     ...
     * swagger分组名称，顺序不能乱
     */
    public static String [] groupNames = {"系统管理"};
     ...
     */
    @Bean(value = "Web")
    public Docket guideWeb() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName(groupNames[0])
                .apiInfo(apiInfo())
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("mp.*"))
...
//				.termsOfServiceUrl("NO terms of service")
                ...
                .description("API接口")
                // 作者
                .contact(new Contact("文档测试","www.baidu.com","111111@163.com"))
